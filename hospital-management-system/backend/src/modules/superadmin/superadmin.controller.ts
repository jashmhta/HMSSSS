...
export class SuperadminController {
  ...
  async getHospitalUsers(@Param('id') id: string) {
    return this.superadminService.getHospitalUsers(id);
  }

  @Post('hospitals/:id/users')
  async createHospitalUser(@Param('id') id: string, @Body() userData: any) {
    return this.superadminService.createHospitalUser(id, userData);
  }

  @Put('users/:id/permissions')
  async updateUserPermissions(@Param('id') id: string, @Body() permissions: any) {
    return this.superadminService.updateUserPermissions(id, permissions);
  }
