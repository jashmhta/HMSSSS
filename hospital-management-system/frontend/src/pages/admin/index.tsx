...
const AdminDashboard: React.FC<IAdminDashboardProps> = ({ adminId = '1' }) => {
  const [stats, setStats] = useState<ISystemStats>({
    totalUsers: 0,
    activeUsers: 0,
    totalPatients: 0,
    totalAppointments: 0,
  ...
  const [systemAlerts, setSystemAlerts] = useState<ISystemAlert[]>([]);
    ...
    const fetchAdminData = async () => {
      try {
        setTimeout(() => {
          ...
          const mockActivity: IRecentActivity[] = [
            {
              id: '1',
              type: 'user_login',
