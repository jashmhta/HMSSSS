...
const StatCard: React.FC<IStatCardProps> = ({ title, value, icon: IconComponent, color, change }) => (
  <div className="bg-white rounded-lg shadow-sm p-6 border">
    <div className="flex items-center justify-between">
      <div>
        <p className="text-sm font-medium text-gray-600">{title}</p>
        <p className="text-3xl font-bold text-gray-900 mt-1">{value}</p>
        <p className="text-sm text-gray-500 mt-1">{change} from last month</p>
      </div>
    ...
    <div className="space-y-3">
      <div className="flex items-start p-3 bg-red-50 border-l-4 border-red-400 rounded">
        ...
        <div>
          ...
          <p className="text-sm text-red-600">Paracetamol tablets running low</p>
        </div>
      </div>
      <div className="flex items-start p-3 bg-yellow-50 border-l-4 border-yellow-400 rounded">
        <AlertTriangle className="h-5 w-5 text-yellow-400 mr-3 mt-0.5" />
        <div>
          <p className="font-medium text-yellow-800">Pending Lab Results</p>
          <p className="text-sm text-yellow-600">12 test results awaiting review</p>
        </div>
      </div>
      <div className="flex items-start p-3 bg-blue-50 border-l-4 border-blue-400 rounded">
        ...
        <div>
          ...
          <p className="text-sm text-blue-600">MRI machine maintenance scheduled</p>
        </div>
      </div>
    </div>
  </div>
...
const createStatCards = (stats: IDashboardStats) => [
  {
