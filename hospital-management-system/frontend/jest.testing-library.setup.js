 ...
 * This file replaces jest.legacy-render.js and jest.setup.js conflicts
 * Provides proper DOM container setup and React Testing Library configuration
 */
...
// Set up DOM containers for React Testing Library
let container = null;
let rootContainer = null;

// Mock react-dom/client to avoid createRoot issues with Jest
jest.mock('react-dom/client', () => ({
  createRoot: jest.fn((container) => ({
    render: jest.fn((element) => {
      // Use legacy ReactDOM render for compatibility
      const { render: legacyRender } = require('react-dom');
...
beforeEach(() => {
  ...
  container.id = 'testing-library-container';
  document.body.appendChild(container);

  // Create root container for React applications
...
if (process.env.NODE_ENV === 'test') {
  ...
  global.debugTestingLibrary = {
    getDocumentBody: () => document.body.innerHTML,
    ...
    dumpDOM: () => {
      ...
      console.log('Root Container:', rootContainer?.innerHTML);
      console.log('===============');
    },
  };
}